  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[var(--unit-text)]">Caja Registradora</h1>
          <p className="text-[var(--unit-text-muted)] mt-1">Gestión de caja, egresos e ingresos</p>
        </div>
      ...
      {summary && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-[var(--unit-surface-elevated)] rounded-unit border border-[var(--unit-border)]/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[var(--unit-text-muted)]">Apertura</p>
                <p className="text-2xl font-bold text-[var(--unit-text)]">
                  S/ {summary.opening?.toFixed(2) || '0.00'}
                </p>
              </div>
              <div className="h-8 w-8 bg-blue-100 rounded-unit flex items-center justify-center">
          ...
          <div className="bg-[var(--unit-surface-elevated)] rounded-unit border border-[var(--unit-border)]/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[var(--unit-text-muted)]">Ventas Efectivo</p>
                <p className="text-2xl font-bold text-green-600">
                  S/ {(summary.cashFromSales || summary.cash || 0).toFixed(2)}
                </p>
              </div>
              <div className="h-8 w-8 bg-green-100 rounded-unit flex items-center justify-center">
          ...
          <div className="bg-[var(--unit-surface-elevated)] rounded-unit border border-[var(--unit-border)]/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[var(--unit-text-muted)]">Tarjetas</p>
          ...
          <div className="bg-[var(--unit-surface-elevated)] rounded-unit border border-[var(--unit-border)]/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-[var(--unit-text-muted)]">Egresos</p>
                <p className="text-2xl font-bold text-red-600">
                  S/ {summary.expenses?.toFixed(2) || '0.00'}
                </p>
              </div>
              <div className="h-8 w-8 bg-red-100 rounded-unit flex items-center justify-center">
      ...
      {openRegister && (
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-unit hover:bg-red-600 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-unit hover:bg-green-600 transition-colors"
          >
      ...
      <div className="bg-[var(--unit-surface-elevated)] rounded-unit border border-[var(--unit-border)]/60 p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-[var(--unit-text)]">Filtros</h3>
          <button
            onClick={() => setShowFilters(!showFilters)}
            className="flex items-center gap-2 text-[var(--unit-text-muted)] hover:text-[var(--unit-text)]"
          >
